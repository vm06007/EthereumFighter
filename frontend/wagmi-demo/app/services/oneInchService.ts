...
const config = {
  makerPrivateKey: process.env.NEXT_PUBLIC_WALLET_KEY || "",
  makerAddress: process.env.NEXT_PUBLIC_WALLET_ADDRESS || "",
  nodeUrl: process.env.NEXT_PUBLIC_RPC_URL_ETHEREUM || "",
  devPortalApiKey: process.env.NEXT_PUBLIC_DEV_PORTAL_KEY || "",
