...
import { insertSQL } from "../helpers/coprocessorUtils";
import { awaitCoprocessor, getClearText } from "../helpers/coprocessorUtils";
...
async function coprocSign(
  ...
  const chainId = process.env.SOLIDITY_COVERAGE === "true" ? 31337 : network.config.chainId;
